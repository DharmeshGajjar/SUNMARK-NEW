    ...
    public class DepartmentController : BaseController
    {
        ...
        public IActionResult Index(long id)
        {
            try
            {
                ...
                departmentMasterModel.StateNm = objProductHelper.GetStateMasterDropdown(companyId, isAdministrator);
                ...
                if (id > 0)
                {
                    ...
                    if (DtDepartment != null && DtDepartment.Rows.Count > 0)
                    {
                        ...
                        departmentMasterModel.DepBtyVou = DbConnection.ParseInt32(DtDepartment.Rows[0]["DepBtyVou"].ToString());
                        departmentMasterModel.DepMemVou = DbConnection.ParseInt32(DtDepartment.Rows[0]["DepMemVou"].ToString());
                        departmentMasterModel.DepInvVou = DbConnection.ParseInt32(DtDepartment.Rows[0]["DepInvVou"].ToString());
                    }
                }
        ...
        public IActionResult Index(long id, DepartmentMasterModel departmentMaster)
        {
            try
            {
                ...
                int companyId = Convert.ToInt32(GetIntSession("CompanyId"));
                int isAdministrator = Convert.ToInt32(GetIntSession("IsAdministrator"));
                departmentMaster.StateNm = objProductHelper.GetStateMasterDropdown(companyId, isAdministrator);
                ...
                if (!string.IsNullOrWhiteSpace(departmentMaster.DepCode) && !string.IsNullOrWhiteSpace(departmentMaster.DepName))
                {
                    ...
                    sqlParameters[4] = new SqlParameter("@DepStateVou", departmentMaster.DepState);
                    ...
                    sqlParameters[10] = new SqlParameter("@DepSTax", departmentMaster.DepSTax);
                    sqlParameters[11] = new SqlParameter("@DepJurd", departmentMaster.DepJurd);
                    sqlParameters[12] = new SqlParameter("@DepBnkNm", departmentMaster.DepBnkNm);
                    sqlParameters[13] = new SqlParameter("@DepAcNo", departmentMaster.DepAcNo);
                    sqlParameters[14] = new SqlParameter("@DepIFSC", departmentMaster.DepIFSC);
                    sqlParameters[15] = new SqlParameter("@DepBnkBrnch", departmentMaster.DepBnkBrnch);
                    sqlParameters[16] = new SqlParameter("@DepWhtMob", departmentMaster.DepWhtMob);
                    sqlParameters[17] = new SqlParameter("@DepBusLine", departmentMaster.DepBusLine);
                    sqlParameters[18] = new SqlParameter("@DepVou", id);
                    sqlParameters[19] = new SqlParameter("@CmpVou", companyId);
                    sqlParameters[20] = new SqlParameter("@UsrVou", userId);
                    sqlParameters[21] = new SqlParameter("@DepLogo", departmentMaster.ProfilePicture);
                    sqlParameters[22] = new SqlParameter("@DepBtyVou", departmentMaster.DepBtyVou);
                    sqlParameters[23] = new SqlParameter("@DepMemVou", departmentMaster.DepMemVou);
                    sqlParameters[24] = new SqlParameter("@DepInvVou", departmentMaster.DepInvVou);
