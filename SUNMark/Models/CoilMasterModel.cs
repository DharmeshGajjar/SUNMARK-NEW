...
namespace SUNMark.Models
{
    public class CoilMasterModel
    {
        ...
        public int NbSchYN { get; set; }
        public List<SelectListItem> NBSCHYesList { get; set; }
    ...
    public class CoilStockPrintDetails
    {
    ...
    public class CoilRegisterPrintDetails
    {
        public string CoilNo { get; set; }
